...
public class WindowPaneTest extends SplitPane {
    ...
    public WindowPaneTest() {
        ...
        controlsColumn.addButton("Add Modal WindowPane With Create Modal Btn", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                WindowPane modalWindow = createModalWindowPane();
                
                Column c = new Column();
                modalWindow.add(c);
                Button b = new Button();
                b.setText("Create new modal window");
                c.add(b);
        ...
        controlsColumn.addButton("Create two modal in one transaction", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                WindowPane modalWindow1 = createModalWindowPane();
                WindowPane modalWindow2 = createModalWindowPane();
                                
                InteractiveApp.getApp().getDefaultWindow().getContent().add(modalWindow1);
                InteractiveApp.getApp().getDefaultWindow().getContent().add(modalWindow2);
            }
        });
        
    }
    
    private WindowPane createModalWindowPane()
    {
    	WindowPane modalWindow = new WindowPane();
        modalWindow.setTitle("Blocking Modal WindowPane");
        modalWindow.setModal(true);
