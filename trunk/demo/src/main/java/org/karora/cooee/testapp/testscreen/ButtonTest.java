...
import org.karora.cooee.testapp.TestGrid;
...
extends SplitPane {
    ...
    public ButtonTest() {
        ...
        testGrid.addHeaderRow("CheckButton");
        
        toggleButton = new ToggleButton();
        testGrid.addTestRow("No Content", toggleButton);
        buttonList.add(toggleButton);

        toggleButton = new ToggleButton("Test CheckButton");
        testGrid.addTestRow("Text", toggleButton);
        buttonList.add(toggleButton);
        
        toggleButton = new ToggleButton(Styles.ICON_LOGO);
        testGrid.addTestRow("Icon", toggleButton);
        buttonList.add(toggleButton);
        
        toggleButton = new ToggleButton("Test CheckButton", Styles.ICON_LOGO);
        testGrid.addTestRow("Text and Icon", toggleButton);
        buttonList.add(toggleButton);
