...
import org.karora.cooee.ng.table.AbleTableSelectionModel;
import org.karora.cooee.ng.table.ColumnHidingTableModel;
import org.karora.cooee.ng.table.DefaultPageableSortableTableModel;
import org.karora.cooee.ng.table.DefaultSortableTableModel;
import org.karora.cooee.ng.table.DefaultTableCellRendererEx;
import org.karora.cooee.ng.table.PageableSortableTable;
import org.karora.cooee.ng.table.PageableTableNavigation;
import org.karora.cooee.ng.table.SortableTable;
import org.karora.cooee.ng.table.SortableTableColumn;
import org.karora.cooee.ng.table.SortableTableModel;
import org.karora.cooee.ng.table.SortableTableSelectionModel;
import org.karora.cooee.ng.table.TableActionEventEx;
import org.karora.cooee.ng.table.TableCellRendererEx;
import org.karora.cooee.ng.testapp.controller.TestController;
import org.karora.cooee.ng.testapp.helpers.TestBooleanHelper;
import org.karora.cooee.ng.testapp.helpers.TestButtonHelper;
import org.karora.cooee.ng.testapp.helpers.TestCallback;
import org.karora.cooee.ng.testapp.helpers.TestDisplaySink;
import org.karora.cooee.ng.testapp.helpers.TestHelper;
...
public class TestTable extends TestCaseBaseNG {
	...
	public Component testSortedTable() {
		...
		selectionTable.setDefaultHeaderRenderer(new DefaultTableCellRendererEx() {
			/**
			 * @see org.karora.cooee.ng.table.TableCellRendererEx#getTableCellRendererContent(org.karora.cooee.app.Table,
	...
	public Component testSpanning() {
		...
		TableCellRendererEx cellRendererEx = new TableCellRendererEx() {
			...
			/**
			 * @see org.karora.cooee.ng.table.TableCellRendererEx#isActionCausingCells(org.karora.cooee.app.Table,
			 *      int, int)
			 */
			...
			/**
			 * @see org.karora.cooee.ng.table.TableCellRendererEx#isSelectionCausingCell(org.karora.cooee.app.Table,
			 *      int, int)
			 */
	...
	public Component testSelection() {
		...
		TableCellRendererEx cellRendererEx = new DefaultTableCellRendererEx() {
			/**
			 * @see org.karora.cooee.ng.table.DefaultTableCellRendererEx#getTableCellRendererContent(org.karora.cooee.app.Table,
			 *      java.lang.Object, int, int)
			 */
			public XhtmlFragment getTableCellRendererContent(Table table, Object value, int column, int row) {
			...
			/**
			 * @see org.karora.cooee.ng.table.DefaultTableCellRendererEx#isActionCausingCells(org.karora.cooee.app.Table,
			 *      int, int)
			 */
			public boolean isActionCausingCell(Table table, int column, int row) {
				return column != row;
			...
			/**
			 * @see org.karora.cooee.ng.table.DefaultTableCellRendererEx#isSelectionCausingCell(org.karora.cooee.app.Table,
			 *      int, int)
			 */
			public boolean isSelectionCausingCell(Table table, int column, int row) {
				return column == row;
	...
	public Component testSelectionInOneColumn() {
		...
		TableCellRendererEx cellRendererEx = new DefaultTableCellRendererEx() {
			/**
			 * @see org.karora.cooee.ng.table.DefaultTableCellRendererEx#getTableCellRendererContent(org.karora.cooee.app.Table, java.lang.Object, int, int)
			 */
			public XhtmlFragment getTableCellRendererContent(Table table, Object value, int column, int row) {
				XhtmlFragment fragment = super.getTableCellRendererContent(table, value, column, row);
				if (column == 0 && row >= 0) {
			...
			/**
			 * @see org.karora.cooee.ng.table.DefaultTableCellRendererEx#isSelectionCausingCell(org.karora.cooee.app.Table, int, int)
			 */
			public boolean isSelectionCausingCell(Table table, int column, int row) {
				return column == 0;
			}
