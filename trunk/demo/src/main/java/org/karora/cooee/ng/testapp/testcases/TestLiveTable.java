...
import org.karora.cooee.ng.table.DefaultLiveTableRenderer;
...
public class TestLiveTable extends TestCaseBaseNG {
	...
	private TableModel genLargeTableModel(final String prefix, int maxRows) {
		TableModel model = new DefaultTableModel(4,maxRows) {
			/**
			 * @see org.karora.cooee.app.table.DefaultTableModel#getValueAt(int, int)
			 */
	...
	public Component testLiveTableWithLinks() {
		...
		LiveTableRenderer renderer = new DefaultLiveTableRenderer() {
			/**
			 * @see org.karora.cooee.ng.table.DefaultLiveTableRenderer#renderRowCell(org.karora.cooee.ng.LiveTable, org.w3c.dom.Element, int, int)
			 */
			...
			/**
			 * @see org.karora.cooee.ng.table.DefaultLiveTableRenderer#renderStyles(org.karora.cooee.ng.LiveTable, org.w3c.dom.Node)
			 */
