...
/**
 * Unit test(s) for <code>org.karora.cooee.app.componentxml.propertypeer.BackgroundImagePeer</code>.
 */
public class AlignmentPeerTest extends TestCase {
    ...
    public void setUp()
    throws Exception {
        InputStream in = AlignmentPeerTest.class.getResourceAsStream("AlignmentPeerTest.stylesheet");
