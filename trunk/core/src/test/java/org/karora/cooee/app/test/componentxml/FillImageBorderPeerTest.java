...
/**
 * Unit test(s) for <code>org.karora.cooee.app.componentxml.propertypeer.FillImageBorderPeer</code>.
 */
public class FillImageBorderPeerTest extends TestCase {
    ...
    public void testSimple() {
        ...
        assertEquals("org/karora/cooee/test/componentxml/BackgroundImage.png", 
