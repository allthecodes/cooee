...
/**
 * Unit test(s) for the <code>org.karora.cooee.app.WindowPane</code> component.
 */
public class WindowPaneTest extends TestCase {
    ...
    public void testInput() {
        ...
        windowPane.setPositionX(Constants.EXTENT_100_PX);
        windowPane.setPositionY(Constants.EXTENT_100_PX);
        windowPane.processInput(WindowPane.PROPERTY_POSITION_X, Constants.EXTENT_200_PX);
        windowPane.processInput(WindowPane.PROPERTY_POSITION_Y, Constants.EXTENT_30_PX);
        assertEquals(Constants.EXTENT_200_PX, windowPane.getPositionX());
        assertEquals(Constants.EXTENT_30_PX, windowPane.getPositionY());
    }
    ...
    public void testPrimaryConstructor() {
        WindowPane windowPane = new WindowPane("Hello", Constants.EXTENT_500_PX, Constants.EXTENT_200_PX);
        assertEquals(Constants.EXTENT_500_PX, windowPane.getWidth());
        assertEquals(Constants.EXTENT_200_PX, windowPane.getHeight());
    ...
    public void testProperties() {
        WindowPane windowPane = new WindowPane();
        windowPane.setBorder(Constants.FILL_IMAGE_BORDER);
        assertEquals(Constants.FILL_IMAGE_BORDER, windowPane.getBorder());
        windowPane.setHeight(Constants.EXTENT_200_PX);
        assertEquals(Constants.EXTENT_200_PX, windowPane.getHeight());
        windowPane.setPositionX(Constants.EXTENT_100_PX);
        assertEquals(Constants.EXTENT_100_PX, windowPane.getPositionX());
        windowPane.setPositionY(Constants.EXTENT_30_PX);
        assertEquals(Constants.EXTENT_30_PX, windowPane.getPositionY());
        ...
        windowPane.setTitleFont(Constants.MONOSPACE_12);
        assertEquals(Constants.MONOSPACE_12, windowPane.getTitleFont());
        windowPane.setTitleForeground(Color.PINK);
        assertEquals(Color.PINK, windowPane.getTitleForeground());
        windowPane.setWidth(Constants.EXTENT_500_PX);
        assertEquals(Constants.EXTENT_500_PX, windowPane.getWidth());
