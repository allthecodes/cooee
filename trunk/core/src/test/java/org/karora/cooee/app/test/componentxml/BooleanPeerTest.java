...
/**
 * Unit test(s) for <code>org.karora.cooee.app.componentxml.propertypeer.BooleanPeer</code>.
 */
public class BooleanPeerTest extends TestCase {
    ...
    public void setUp()
    throws Exception {
        InputStream in = IntegerPeerTest.class.getResourceAsStream("BooleanPeerTest.stylesheet");
