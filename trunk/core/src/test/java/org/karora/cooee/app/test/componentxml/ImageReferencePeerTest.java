...
/**
 * Unit test(s) for <code>org.karora.cooee.app.componentxml.propertypeer.FontPeer</code>.
 */
public class ImageReferencePeerTest extends TestCase {
    ...
    public void testResourceImageReferenceInline() {
        ...
        assertEquals("org.karora.cooee/test/componentxml/Alpha.png", icon.getResource());
    }
    ...
    public void testResourceImageReferencePlain() {
        ...
        assertEquals("org.karora.cooee/test/componentxml/Bravo.png", icon.getResource());
    }
    ...
    public void testResourceImageReferenceDimensioned() {
        ...
        assertEquals("org.karora.cooee/test/componentxml/Charlie.png", icon.getResource());
    ...
    public void testResourceImageReferenceContentTypeHalfDimensioned() {
        ...
        assertEquals("org.karora.cooee/test/componentxml/Delta.whoknows", icon.getResource());
