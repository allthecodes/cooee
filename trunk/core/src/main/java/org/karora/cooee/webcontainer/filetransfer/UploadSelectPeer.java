...
implements DomUpdateSupport, ActionProcessor, PropertyUpdateProcessor, ComponentSynchronizePeer {
     ...
     */
    private static final Extent DEFAULT_WIDTH = new Extent(300, Extent.PX);
    ...
    /**
     * @see org.karora.cooee.webcontainer.ComponentSynchronizePeer#renderDispose(RenderContext,
    ...
    /**
     * @see org.karora.cooee.webcontainer.ComponentSynchronizePeer#renderUpdate(RenderContext,
