...
public interface LazyRenderContainer {
    ...
    /**
     * Determines if the specified <code>child</code> has been rendered 
     * to the client.
     * 
     * @param ci the relevant <code>ContainerInstance</code>
     * @param component the lazy-load-supporting container component
     * @param child the child component to test for rendering
     */
    public boolean isRendered(ContainerInstance ci, Component component, Component child);
}
