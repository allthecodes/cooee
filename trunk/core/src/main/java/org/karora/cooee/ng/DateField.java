...
public class DateField extends DropDown {
	...
	/**
	 * @see org.karora.cooee.ng.PopUp#processInput(java.lang.String, java.lang.Object)
	 */
	...
	/**
	 * A shortcut method to the underlying DateChooser's model
	 ...
	 * <p>
	 * This will also have the effect of setting the text of the
	 * <code>TextField</code> since the DateField is listening to the
	 * underlying <code>CalendarSelectionModel</code>.
	 * 
	...
	/**
	 * @see org.karora.cooee.app.Component#validate()
	 */
