...
implements HttpSessionActivationListener, HttpSessionBindingListener, Serializable {
    ...
    public static final String PROPERTY_SERVER_STARTUP_MESSAGE = "serverStartupMessage";
    public static final String BASE_CLIENT_DOCUMENT_IMPLEMENTATION = "baseClientDocumentImpl";
     ...
     * 
     */
    private ServerProgressMessage serverStartupMessage;
    ...
    /**
     * A <code>BaseClientDocument</code> object that specifies how the application
     * should be initially rendered.
     * 
     * @since Cooee 1.1
     * 
     */
    private Class baseClientDocumentClass;
    ...
    public Class getBaseClientDocumentClass()
    {
    	return baseClientDocumentClass;
    }
   ...
   /**
    ...
    public void setBaseClientDocumentClass(Class baseClientDocument)
    {
    	this.baseClientDocumentClass = baseClientDocument;
    	
    	//XXX: Assumes that whatever is being used as a base client document is a direct superclass -- could cause problems
    	
    	if (baseClientDocument.getSuperclass() != BaseClientDocument.class)
    		throw new IllegalArgumentException("Invalid class type for Base Client Document");
    	
    	updateManager.processPropertyUpdate(BASE_CLIENT_DOCUMENT_IMPLEMENTATION);
    }
	...
	/*
	 * EXPERIEMENTAL.
	 * public void setServerStartupMessage(ServerProgressMessage serverStartupMessage) {
		this.serverStartupMessage = serverStartupMessage;
	}
	
	public ServerProgressMessage getServerStartupMessage() {
