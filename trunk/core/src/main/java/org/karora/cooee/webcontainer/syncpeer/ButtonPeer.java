 ...
 * <code>org.karora.cooee.app.AbstractButton</code>-derived components.
 * <p>
...
implements ActionProcessor, DomUpdateSupport, ImageRenderSupport, PropertyUpdateProcessor, ComponentSynchronizePeer {
    ...
    private static final ImageReference DEFAULT_CHECKBOX_ICON
            = new ResourceImageReference("/org/karora/cooee/webcontainer/resource/image/CheckBoxOff.gif");
    private static final ImageReference DEFAULT_SELECTED_CHECKBOX_ICON 
            = new ResourceImageReference("/org/karora/cooee/webcontainer/resource/image/CheckBoxOn.gif");
    private static final ImageReference DEFAULT_RADIOBUTTON_ICON
            = new ResourceImageReference("/org/karora/cooee/webcontainer/resource/image/RadioButtonOff.gif");
    private static final ImageReference DEFAULT_SELECTED_RADIOBUTTON_ICON 
            = new ResourceImageReference("/org/karora/cooee/webcontainer/resource/image/RadioButtonOn.gif");
    ...
    private static final Service BUTTON_SERVICE = JavaScriptService.forResource("Echo.Button", 
            "/org/karora/cooee/webcontainer/resource/js/Button.js");
    ...
    private void renderButtonContent(RenderContext rc, Element buttonContainerElement, AbstractButton button) {
        ...
        ToggleButton toggleButton = (button instanceof CheckBox || button instanceof RadioButton) ? (ToggleButton) button : null;
    ...
    private void renderInitDirective(RenderContext rc, AbstractButton button) {
        ...
        if (button instanceof ToggleButton) {
          ...
          if (button instanceof ToggleButton) {
        	  ButtonGroup buttonGroup = ((ToggleButton) toggleButton).getGroup();
        	  if (buttonGroup != null) {
