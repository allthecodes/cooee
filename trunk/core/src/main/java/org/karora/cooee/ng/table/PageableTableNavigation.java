...
public class PageableTableNavigation extends Row {
    ...
    private Label getPageLabel() {
    	Label label = new Label(" "+Messages.getString("Page")+" : ");
        return label;
    }
    ...
    private Button getPreviousButton(){
    	Button previousButton = new Button(Messages.getString("Previous"));
    ...
    private Button getNextButton(){
    	Button nextButton = new Button(Messages.getString("Next"));
