...
public class StackedPaneEx extends ContentPaneEx {
	...
	protected void fireStackChanged() {
		fireStackChanged(null, null);
	}

	/**
	 * Called to indicate that the stack has been changed.
	 * 
	 * @param old the Component that was at the top of the stack
	 * @param top the Component that is now at the top of the stack
	 */
	protected void fireStackChanged(Component old, Component top) {
		firePropertyChange(STACK_CHANGED_PROPERTY, old, top);
	}
	...
	/**
	 * @see org.karora.cooee.app.Component#remove(org.karora.cooee.app.Component)
	 */
	public void remove(Component c) {
		super.remove(c);
		if (stack.contains(c)) {
			stack.remove(c);
			fireStackChanged(c, peek());
		}
	}

	/**
	 * @see org.karora.cooee.app.Component#remove(int)
	 */
	...
	/**
	 * @see org.karora.cooee.app.Component#removeAll()
	 */
