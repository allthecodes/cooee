...
extends StreamImageReference {
    ...
    /**
     * @see org.karora.cooee.app.StreamImageReference#getContentType()
     */
    ...
    /**
     * @see org.karora.cooee.app.ImageReference#getHeight()
     */
    ...
    /**
     * @see org.karora.cooee.app.ImageReference#getWidth()
     */
    ...
    /**
     * @see org.karora.cooee.app.StreamImageReference#render(java.io.OutputStream)
     */
    ...
    throws IOException {
        ...
        try {
            // All this code is being duplicated in the Resource class, except
            // for the context class loader.  As such, I think all resource loading
            // needs to be centralised.
            if (OSGIDetector.isOSGIEnvironment())
            {
                //This is not the greatest fix in the world
                in = new ByteArrayInputStream(Resource.getResourceAsByteArray(resource));
            }
            else
            {
            ...
            if (in == null) {
            	/* attempt to load a default image */
                in = Thread.currentThread().getContextClassLoader().getResourceAsStream("/org/karora/cooee/webcontainer/resource/image/default.png");
                
                /* still no image?  Throw an exception */
                if (in == null)
