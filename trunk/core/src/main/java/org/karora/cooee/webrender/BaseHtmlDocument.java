 ...
 * 
 * Please note: This class is now deprecated and will no longer
 * be called by the framework.
 * 
 * Please use the new classes available in org.karora.cooee.webrender.startup
 * 
 * @since Echo v2.0
 * @deprecated Use <code>BaseClientDocument</code> instead
 */
public class BaseHtmlDocument extends HtmlDocument {
    ...
    public BaseHtmlDocument(String contentId) {
        ...
        //Element manlyDiv = document.createElement("div");
        //manlyDiv.setAttribute("id", "customLoader");
        
        //loadingDiv.setAttribute("customLoadStatus", "pie");
        
        loadingDiv.appendChild(document.createTextNode("I'm getting in the way of your life you cow"));
        //loadingDiv.appendChild(manlyDiv);
