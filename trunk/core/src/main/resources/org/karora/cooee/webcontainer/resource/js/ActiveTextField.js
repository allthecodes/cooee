...
ActiveTextField.getComponent = function(element) {
...
ActiveTextField.processBlur = function(echoEvent) {
    var textComponent = ActiveTextField.getComponent(echoEvent.registeredTarget);
...
ActiveTextField.processFocus = function(echoEvent) {
    var textComponent = ActiveTextField.getComponent(echoEvent.registeredTarget);
...
ActiveTextField.processKeyPress = function(e) {
    e = e ? e : window.event;
    var target = EchoDomUtil.getEventTarget(e);
    var textComponent = ActiveTextField.getComponent(target);
 ...
 *        <code>EchoEventProcessor</code>
 */
ActiveTextField.processKeyUp = function(echoEvent) {
    var textComponent = ActiveTextField.getComponent(echoEvent.registeredTarget);
    textComponent.processKeyUp(echoEvent);
};


ActiveTextField.processChange = function(echoEvent) {
    var textComponent = ActiveTextField.getComponent(echoEvent.registeredTarget);
...
ActiveTextField.MessageProcessor = function() { };
...
ActiveTextField.MessageProcessor.processDispose = function(disposeMessageElement) {
    for (var item = disposeMessageElement.firstChild; item; item = item.nextSibling) {
        var elementId = item.getAttribute("eid");
        var textComponent = ActiveTextField.getComponent(elementId);
        if (textComponent) {
...
ActiveTextField.MessageProcessor.processSetText = function(setTextMessageElement) {

    for (var item = setTextMessageElement.firstChild; item; item = item.nextSibling) {
        var elementId = item.getAttribute("eid");
        var text = item.getAttribute("text");
        var element = document.getElementById(elementId);
        var textComponent = ActiveTextField.getComponent(element);
...
ActiveTextField.MessageProcessor.processSetForeground = function(setTextMessageElement) {
    ...
    for (var item = setTextMessageElement.firstChild; item; item = item.nextSibling) {
        ...
        var componentObject = ActiveTextField.getComponent(inputElement);
...
ActiveTextField.MessageProcessor.processSetBackground = function(setTextMessageElement) {
...
ActiveTextField.MessageProcessor.processSetEnabled = function(setTextMessageElement) {
