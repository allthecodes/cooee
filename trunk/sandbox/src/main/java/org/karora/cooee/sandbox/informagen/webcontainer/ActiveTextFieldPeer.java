 ...
 * <code>org.karora.cooee.sandbox.informagen.app.ActiveTextField</code>
 */
...
public abstract class ActiveTextFieldPeer implements ActionProcessor, 
    ...
    static final Service ACTIVE_TEXTFIELD_SERVICE = JavaScriptService.forResource(
                    "sandbox.informagen.ActiveTextField",
                    "/org/karora/cooee/sandbox/informagen/webcontainer/resource/js/ActiveTextField.js");


	private static final Service GOOD_ICON_IMAGE = StaticBinaryService.forResource(
	                "sandbox.informagen.images.goodIcon", 
	                "image/png",
			        "/org/karora/cooee/sandbox/informagen/webcontainer/resource/image/good.icon.png");

	private static final Service WARNING_ICON_IMAGE = StaticBinaryService.forResource(
	                "sandbox.informagen.images.warningIcon", 
	                "image/png",
			        "/org/karora/cooee/sandbox/informagen/webcontainer/resource/image/warning.icon.png");

	private static final Service ERROR_ICON_IMAGE = StaticBinaryService.forResource(
	                "sandbox.informagen.images.errorIcon", 
	                "image/png",
			        "/org/karora/cooee/sandbox/informagen/webcontainer/resource/image/error.icon.png");
