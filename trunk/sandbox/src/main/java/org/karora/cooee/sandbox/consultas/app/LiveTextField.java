 ...
 */
public class LiveTextField extends Component {
   ...
   *          the desired model
   */
	public LiveTextField(Document document) {
		super();
		setDocument(document);
	}

	/**
   * Adds an <code>ActionListener</code> to the <code>TextField</code>. The
   * <code>ActionListener</code> will be invoked when the user presses the
   ...
   */
	...
	/**
   * Returns the height of the text component. This property only supports
   ...
   */
	...
	/**
   * Returns the maximum length (in characters) of the text which may be entered
   * into the component.
   * 
   ...
   */
	...
	/**
   * Returns the tool tip text (displayed when the mouse cursor is hovered over
   * the component).
   * 
   ...
   */
	...
	/**
   * Returns the width of the text component. This property supports
   * <code>Extent</code>s with either fixed or percentage-based units.
   * 
   * @return the width
   */
   ...
   */
	...
	/**
   * Sets the action command which will be provided in <code>ActionEvent</code>s
   * fired by this <code>TextField</code>.
   * 
   * @param newValue
   ...
   */
	...
	/**
   * Sets the height of the text component. This property only supports
   * <code>Extent</code>s with fixed (i.e., not percent) units.
   * 
   * @param newValue
   *          the new height
   */
	...
	/**
   * Sets the horizontal scroll bar position. The provided <code>Extent</code>
   * value must be in pixel units.
   * 
   * @param newValue
   ...
   */
	...
	/**
   * Sets the maximum length (in characters) of the text which may be entered
   * into the component.
   * 
   * @param newValue
   *          the new maximum length, or -1 if to specify an unlimited length
   */
   ...
   */
	...
	/**
   * Sets the tool tip text (displayed when the mouse cursor is hovered over the
   * component).
   * 
   * @param newValue
   ...
   */
	...
	/**
   * Sets the vertical scroll bar position. The provided <code>Extent</code>
   * value must be in pixel units.
   * 
   * @param newValue
   *          the new scroll bar position
   */
	...
	/**
   * Sets the width of the text component. This property supports
   * <code>Extent</code>s with either fixed or percentage-based units.
   * 
   * @param newValue
   *          the new width
   */
	...
	public void setRegexp(String newValue) {
		setProperty(PROPERTY_REGEXP, newValue);
	}
   ...
   */
	public LiveTextField(Document document, String text, int columns) {
