...
import org.karora.cooee.app.ModalSupport;
 ...
 * window.
 * <p>
 * <b>NOTE:</b> A <code>SpWindowPane</code> may only be added to a
 * <code>ContentPane</code>.
 */
public class SpWindowPane extends Component implements FloatingPane,
		ModalSupport, PaneContainer {
	 ...
	 * indicating that nothing should be done when the user attempts to close a
	 * window.
	 */
	...
	/**
	 * A constant for the <code>defaultCloseOperation</code> property
	 * indicating that a window should be hidden when the user attempts to close
	 * it.
	 */
	...
	/**
	 * A constant for the <code>defaultCloseOperation</code> property
	 * indicating that a window should be removed from the component hierarchy
	...
	/**
	 * Creates a new <code>SpWindowPane</code>.
	 */
	public SpWindowPane() {
		this(null, null, null);
	}
	...
	/**
	 * Creates a new <code>SpWindowPane</code> with the specified title and
	 * dimensions.
	 * 
	 * @param title
	 *            the title
	 ...
	 *            The height
	 */
	public SpWindowPane(String title, Extent width, Extent height) {
		super();
		if (title != null) {
			setTitle(title);
		}
	 ...
	 * 
	 * @param l
	 *            the <code>WindowPaneListener</code> to add
	 */
	 ...
	 * to close this <code>SpWindowPane</code>.
	 */
	...
	/**
	 * Returns the background image of the <code>SpWindowPane</code>.
	 * 
	...
	/**
	 * Returns the border which surrounds the entire <code>SpWindowPane</code>.
	 * 
	 * @return border
	 */
	...
	public int getDefaultCloseOperation() {
		...
		return defaultCloseOperationValue == null ? 0
				: defaultCloseOperationValue.intValue();
	}
	...
	/**
	 * Returns the inset of the window content. This property is not rendered
	 * when the content is a <code>Pane</code> component.
	 * 
	 * @return the inset
	 */
	...
	/**
	 * Returns the horizontal (Y) position of the <code>SpWindowPane</code>
	...
	/**
	 * Returns the vertical (Y) position of the <code>SpWindowPane</code> with
	...
	/**
	 * Returns the title of the <code>SpWindowPane</code>.
	 * 
	 * @return the title
	 */
	 ...
	 * <code>ContentPane</code>. Windows with higher z-indices will visually
	 * obscure windows with lower z-indices.
	 * 
	 * @return the z-index
	 */
	...
	/**
	 * Determines if the window is closable via a provided close button in the
	 * title bar.
	 * 
	...
	/**
	 * Determines if the window is maximazable via a provided maximize button in
	 * the title bar.
	 * 
	 * @return true if the window is closable
	 */
	...
	/**
	 * Determines if the window is minimazable via a provided minimize button in
	 * the title bar.
	 * 
	 * @return true if the window is closable
	 */
	...
	/**
	 * Sets the background image of the <code>SpWindowPane</code>.
	 * 
	 * @param newValue
	...
	/**
	 * Sets the border which surrounds the entire <code>SpWindowPane</code>.
	 * 
	 * @param newValue
	 *            the new border
	 */
	...
	/**
	 * Sets whether the window is closable via a provided close button in the
	 * title bar.
	 * 
	 * @param newValue
	 ...
	 * 
	 * @param newValue
	 *            the new default close operation, one of the following values:
	 *            <ul>
	 *            <li>DO_NOTHING_ON_CLOSE</li>
	 *            <li>HIDE_ON_CLOSE</li>
	 *            <li>DISPOSE_ON_CLOSE</li>
	...
	/**
	 * Sets the height of the content region of the <code>SpWindowPane</code>.
	...
	/**
	 * Sets the inset of the window content. This property is not rendered when
	 * the content is a <code>Pane</code> component.
	 * 
	 * @param newValue
	 *            the new inset
	 */
	 ...
	 * <code>SpWindowPane</code>. Values must be in pixel units.
	 * 
	 * @param newValue
	...
	public void setModal(boolean newValue) {
		...
		modal = newValue;
		firePropertyChange(MODAL_CHANGED_PROPERTY, new Boolean(oldValue),
	 ...
	 * 
	 * @param newValue
	 *            true if the window may be moved by the user
	 */
	...
	/**
	 * Sets the horizontal (X) position of the <code>SpWindowPane</code> with
	 * respect to its container. Values must be in pixel units.
	 * 
	 * @param newValue
	 *            the new position
	 */
	...
	/**
	 * Sets the vertical (Y) position of the <code>SpWindowPane</code> with
	 * respect to its container. Values must be in pixel units.
	 * 
	 * @param newValue
	 *            the new position
	 ...
	 * 
	 * @param newValue
	 *            true if the window may be resized by the user
	 */
	...
	/**
	 * Sets the title of the <code>SpWindowPane</code>.
	 * 
	 * @param newValue
	 *            the title
	 */
	...
	/**
	 * Sets the width of the content region of the window. Values must be in
	 * pixel units.
	 * 
	 * @param newValue
	 *            the new width
	...
	/**
	 * Removes a <code>WindowPaneListener</code> from receiving event
	 * notifications.
	 * 
	 * @param l
	 *            the <code>WindowPaneListener</code> to remove
	 */
	...
	public void userClose() {
		...
		int defaultCloseOperation = defaultCloseOperationValue == null ? DISPOSE_ON_CLOSE
				: defaultCloseOperationValue.intValue();
