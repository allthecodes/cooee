...
sandbox_informagen_IntegerTextField = function(elementId) {
...
sandbox_informagen_IntegerTextField.prototype.init = function() {
...
sandbox_informagen_IntegerTextField.prototype.dispose = function() {
...
sandbox_informagen_IntegerTextField.prototype.getElement = function() {
    return document.getElementById(this.elementId);
};

sandbox_informagen_IntegerTextField.prototype.getInput = function() {
...
sandbox_informagen_IntegerTextField.prototype.doAction = function() {
...
sandbox_informagen_IntegerTextField.prototype.doValidationTransition = function() {
...
sandbox_informagen_IntegerTextField.prototype.processBlur = function(echoEvent) {
...
sandbox_informagen_IntegerTextField.prototype.processFocus = function(echoEvent) {
...
sandbox_informagen_IntegerTextField.prototype.processKeyPress = function(e) {
// 
 ...
 *        <code>EchoEventProcessor</code>
 */
sandbox_informagen_IntegerTextField.prototype.processKeyUp = function(echoEvent) {
...
sandbox_informagen_IntegerTextField.prototype.processChange = function(echoEvent) {
...
sandbox_informagen_IntegerTextField.prototype.validateText = function () {
...
sandbox_informagen_IntegerTextField.prototype.validateRange = function () {
...
sandbox_informagen_IntegerTextField.prototype.updateClientMessage = function() {
    var input = this.getInput();
...
sandbox_informagen_IntegerTextField.MessageProcessor = function() { };
...
sandbox_informagen_IntegerTextField.MessageProcessor.process = function(messagePartElement) {
    ...
    for (var i = 0; i<messagePartElement.childNodes.length; ++i) {
        ...
        if (messagePartElement.childNodes[i].nodeType == 1) {  // Node.ELEMENT_NODE = 1
            ...
            case "init":
                sandbox_informagen_IntegerTextField.MessageProcessor.processInit(messagePartElement.childNodes[i]);
                break;
...
sandbox_informagen_IntegerTextField.MessageProcessor.processInit = function(initMessageElement) {

    for (var item = initMessageElement.firstChild; item; item = item.nextSibling) {
    
        var elementId = item.getAttribute("eid");        
        var textComponent = new sandbox_informagen_IntegerTextField(elementId);
