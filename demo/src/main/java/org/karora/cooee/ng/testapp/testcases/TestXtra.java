...
import org.karora.cooee.ng.ListBoxEx;
import org.karora.cooee.ng.ListSection;
import org.karora.cooee.ng.Menu;
import org.karora.cooee.ng.MenuBar;
import org.karora.cooee.ng.MenuButton;
import org.karora.cooee.ng.MenuItem;
...
import org.karora.cooee.ng.SelectFieldEx;
import org.karora.cooee.ng.Separator;
import org.karora.cooee.ng.TabbedPane;
import org.karora.cooee.ng.TemplatePanel;
import org.karora.cooee.ng.TextAreaEx;
...
public class TestXtra extends TestCaseBaseNG {
	...
	/**
	 * @see org.karora.cooee.ng.testapp.testcases.TestCaseBaseNG#getTestCategory()
	 */
	...
	public Component testExternalEventMonitor() {
		...
		eventMonitor.addExternalEventListener(new ExternalEventListener() {
			/**
			 * @see org.karora.cooee.ng.externalevent.ExternalEventListener#externalEvent(org.karora.cooee.ng.externalevent.ExternalEvent)
			 */
	...
	public Component testLightBox() {
		...
		WindowPaneListener listener = new WindowPaneListener() {
			public void windowPaneClosing(org.karora.cooee.app.event.WindowPaneEvent e) {
				lightBox.hide();
			};
		};
