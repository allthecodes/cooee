...
import org.karora.cooee.webcontainer.syncpeer.AccordionPanePeer;
...
public class AccordionPaneTest extends AbstractTest {
    ...
    public AccordionPaneTest() {
        ...
        final PropertyChangeListener pcl = new PropertyChangeListener() {
			...
			public void propertyChange(PropertyChangeEvent pce) {
				if (pce.getPropertyName() == TabPane.ACTIVE_TAB_INDEX_CHANGED_PROPERTY) {
					InteractiveApp.getApp().consoleWrite("Tab #" + accordionPane.getActiveTabIndex() + " is selected");
				}
			}
        ...
        testControlsPane.addButton("Property Changed Listeners", "Active Tab Index Changed = off", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	if (pclIsAdded) {
            		accordionPane.removePropertyChangeListener(pcl);
            		pclIsAdded = false;
            	}
            }
        });
        ...
        testControlsPane.addButton("Property Changed Listeners", "Active Tab Index Changed = on (check Console)", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	if (!pclIsAdded) {
            		accordionPane.addPropertyChangeListener(pcl);
            		pclIsAdded = true;
            	}
            }
        });
