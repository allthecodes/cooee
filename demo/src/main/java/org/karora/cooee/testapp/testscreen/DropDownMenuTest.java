...
import org.karora.cooee.app.menu.DefaultMenuSelectionModel;
...
public class DropDownMenuTest extends AbstractTest {
    ...
    public DropDownMenuTest() {
        ...
        testControlsPane.addButton(TestControlPane.CATEGORY_PROPERTIES, "Enable Default Menu Id", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                menu.setDefaultMenuId("new");
            }
        });
        
        testControlsPane.addButton(TestControlPane.CATEGORY_PROPERTIES, "Disable Default Menu Id", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                menu.setDefaultMenuId(null);
            }
        });
