...
public class AbstractTest extends SplitPane {
    ...
    protected static final int MAX_EXTENT_VALUE = 100;
    ...
    protected void addBorderPropertyTests(String category, final String propertyName) {
        ...
        testControlsPane.addButton(category, propertyName + ": none", new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                setTestComponentProperty(propertyName, Border.class, 
                		new Border(new Extent(0), Color.BLACK, Border.STYLE_NONE));
            }
        });
    ...
    protected void addExtentPropertyTests(String category, final String propertyName, int number) {
    	for(int i=0; i<number; ++i)
    	{
            testControlsPane.addButton(category, propertyName + ": Randomize", new ActionListener(){
                public void actionPerformed(ActionEvent e) {
                    setTestComponentProperty(propertyName, Extent.class, StyleUtil.randomExtent(MAX_EXTENT_VALUE));
                }
            });
    	}
        ...
        testControlsPane.addButton(category, propertyName + ": null", new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                setTestComponentProperty(propertyName, Extent.class, null);
            }
        });
    }
