...
public class ToggleButton extends AbstractButton {
    ...
    private ChangeListener changeMonitor = new ChangeListener() {
        ...
        public void stateChanged(ChangeEvent e) {
            if (buttonGroup != null) {
                buttonGroup.updateSelection(ToggleButton.this);
            }
        }
    };
     ...
     * @param icon the icon to be displayed in the button
     */
    public ToggleButton(String text, ImageReference icon) {
        super();
    ...
    /**
     * @see org.karora.cooee.app.button.AbstractButton#setModel(org.karora.cooee.app.button.ButtonModel)
     */
