...
public class SortableTableHeaderRenderer implements TableCellRenderer {
	...
	public static final ImageReference DEFAULT_UP_ARROW_IMAGE = new ResourceImageReference("/org/karora/cooee/ng/resource/images/ArrowUp.gif");

	public static final ImageReference DEFAULT_DOWN_ARROW_IMAGE = new ResourceImageReference("/org/karora/cooee/ng/resource/images/ArrowDown.gif");
