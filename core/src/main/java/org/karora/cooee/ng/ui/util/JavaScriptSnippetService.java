...
import org.karora.cooee.webrender.util.JavaScriptCompressor;
...
public class JavaScriptSnippetService implements Service {
	...
	/**
	 * @see org.karora.cooee.webrender.server.Service#getId()
	 */
	public String getId() {
		return id;
	}
	...
	/**
	 * @see org.karora.cooee.webrender.server.Service#getVersion()
	 */
	...
	/**
	 * @see org.karora.cooee.webrender.server.Service#service(org.karora.cooee.webrender.server.Connection)
	 */
