...
import org.karora.cooee.ng.richtext.DefaultRichTextRenderer;
 ...
 * 
 * @see org.karora.cooee.ng.richtext.RichTextRenderer
 * 
 */
public class RichTextArea extends TextComponent implements Sizeable, Insetable, MouseCursorable, Borderable, Attributeable  {
	...
	public static final String PROPERTY_SHOW_TOOLBAR = "showToolbar";
	...
	public Color getToolBarBackground() {
	 ...
	 /** 
     * @return Returns whether the tool bar is to be shown. 
     */
    public boolean isShowToolbar()
    {
        if (getProperty(PROPERTY_SHOW_TOOLBAR) == null)
        	return true;
        else
        	return (Boolean) getProperty(PROPERTY_SHOW_TOOLBAR);
	...
	/**
	 * @see org.karora.cooee.app.text.TextComponent#processInput(java.lang.String, java.lang.Object)
	 */
    ...
    {
        setProperty(PROPERTY_SHOW_TOOLBAR, value);
    }
}