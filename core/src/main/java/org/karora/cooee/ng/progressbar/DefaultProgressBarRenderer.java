...
public class DefaultProgressBarRenderer implements ProgressBarRenderer, java.io.Serializable {
	 ...
	 */
	private org.karora.cooee.app.Font _findFont(Component c) {

		org.karora.cooee.app.Font fnt = c.getFont();
	...
	public ImageReference drawProgressBar(ProgressBar progressBar) {
		...
		org.karora.cooee.app.Color borderColor = (border == null ? null : border.getColor());
	...
	private org.karora.cooee.app.Color getRPColor(Component c, String propertyName, Style fallbackStyle) {
		Object value = c.getRenderProperty(propertyName);
		if (value == null && fallbackStyle != null) {
			value = fallbackStyle.getProperty(propertyName);
		}
		return (org.karora.cooee.app.Color) value;
	}
