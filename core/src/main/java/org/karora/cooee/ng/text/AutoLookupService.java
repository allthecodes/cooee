...
public class AutoLookupService implements Service {
	...
	public synchronized void register(AutoLookupTextFieldEx textFieldEx) {
		interestedParties.put(getInterestedPartyKey(textFieldEx), textFieldEx);
	}
	...
	public synchronized void deregister(AutoLookupTextFieldEx textFieldEx) {
		interestedParties.remove(getInterestedPartyKey(textFieldEx));
	}
	...
	/**
	 * Defines the key that will be used when registering a ALTextFieldEx as an "interested party"
	 * 
	 * @param textFieldEx
	 * @return
	 */
	private String getInterestedPartyKey(AutoLookupTextFieldEx textFieldEx)
	{
		return KEY_PREFIX + textFieldEx.getRenderId();
	}
