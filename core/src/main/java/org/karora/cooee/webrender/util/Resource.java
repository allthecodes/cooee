...
public class Resource {
    ...
    {
    	return getResourceAsInputStream(resourceName);
    }
    /**
     * An internal method used to retrieve a resource as a
     * <code>ByteArrayOutputStream</code>.
     * 
     * In this class, this method serves as a delegation to environment
     * specific resource locators.
     * 
     *
     * @param resourceName The name of the resource to be retrieved.
    ...
    private static ByteArrayOutputStream getResource(String resourceName) {
        ...
        {
            return OSGIResourceLocator.getResource(resourceName);
        }
        else
        {
            return DefaultResourceLocator.getResource(resourceName);
        }
        
    }
    
    private static InputStream getResourceAsInputStream(String resourceName)
    {
    	if (OSGIDetector.isOSGIEnvironment())
        {
            return OSGIResourceLocator.getResourceAsStream(resourceName);
        }
        else
        {
            return DefaultResourceLocator.getResourceAsStream(resourceName);
        }
    }
