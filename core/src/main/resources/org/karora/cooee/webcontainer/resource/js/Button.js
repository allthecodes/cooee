...
EchoButton.prototype.setSelected = function(newState) {
    ...
    var newStateIcon = this.selected ? this.selectedStateIcon : this.stateIcon;
    var newStyle = (this.selected && !newStateIcon) ? this.pressedStyle : null;
    var newIcon = (this.selected && !newStateIcon) ? this.pressedIcon : this.defaultIcon;
...
EchoButton.prototype.setVisualState = function(newState) {
    ...
    default:
        ...
        newStyle = (this.selected && !newStateIcon) ? this.pressedStyle : null;
        newIcon = (this.selected && !newStateIcon) ? this.pressedIcon : this.defaultIcon;
    }
