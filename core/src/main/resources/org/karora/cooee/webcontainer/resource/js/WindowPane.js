 ...
 */
EchoWindowPane.prototype.loadContainerSize = function() {
    var containerElement = document.getElementById(this.containerElementId);
...
EchoWindowPane.ZIndexManager.add = function(containerId, elementId) {
    ...
    var currentModalElementId = EchoWindowPane.ZIndexManager.currentModelElementId;
...
EchoWindowPane.ZIndexManager.raise = function(containerId, elementId) {
    ...
    if (EchoModalManager.modalElementId != null && EchoModalManager.modalElementId != '')
    {
       var modalWindow = document.getElementById(EchoModalManager.modalElementId);
       if (modalWindow.style.zIndex <= raiseIndex)
       {
           modalWindow.style.zIndex = raiseIndex + 10;
       }
