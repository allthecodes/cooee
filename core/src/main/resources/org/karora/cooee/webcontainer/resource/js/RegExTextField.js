...
RegExTextField = function(elementId) {
...
RegExTextField.prototype.init = function() {
    ...
    //fixed enabled state of RegExTextField
...
RegExTextField.prototype.dispose = function() {
...
RegExTextField.prototype.getElement = function() {
    return document.getElementById(this.elementId);
};

RegExTextField.prototype.getInput = function() {
...
RegExTextField.prototype.doAction = function() {
...
RegExTextField.prototype.doValidationTransition = function() {
...
RegExTextField.prototype.processBlur = function(echoEvent) {
...
RegExTextField.prototype.processFocus = function(echoEvent) {
...
RegExTextField.prototype.processKeyPress = function(e) {
 ...
 *        <code>EchoEventProcessor</code>
 */
RegExTextField.prototype.processKeyUp = function(echoEvent) {
...
RegExTextField.prototype.processChange = function(echoEvent) {
...
RegExTextField.prototype.validateText = function () {
...
RegExTextField.prototype.updateClientMessage = function() {
    var input = this.getInput();
...
RegExTextField.MessageProcessor = function() { };
...
RegExTextField.MessageProcessor.process = function(messagePartElement) {
    ...
    for (var i = 0; i<messagePartElement.childNodes.length; ++i) {
        ...
        if (messagePartElement.childNodes[i].nodeType == 1) {  // Node.ELEMENT_NODE = 1
            ...
            case "init":
                RegExTextField.MessageProcessor.processInit(messagePartElement.childNodes[i]);
                break;
...
RegExTextField.MessageProcessor.processInit = function(initMessageElement) {


    for (var item = initMessageElement.firstChild; item; item = item.nextSibling) {
    
        var elementId = item.getAttribute("eid");        
        var textComponent = new RegExTextField(elementId);
