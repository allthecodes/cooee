...
NumericTextField = function(elementId) {
...
NumericTextField.prototype.init = function() {
    ...
    //fixed enabled state of NumericTextField
...
NumericTextField.prototype.dispose = function() {
...
NumericTextField.prototype.getElement = function() {
    return document.getElementById(this.elementId);
};

NumericTextField.prototype.getInput = function() {
...
NumericTextField.prototype.doAction = function() {
...
NumericTextField.prototype.doValidationTransition = function() {
...
NumericTextField.prototype.processBlur = function(echoEvent) {
...
NumericTextField.prototype.processFocus = function(echoEvent) {
...
NumericTextField.prototype.processKeyPress = function(e) {
 ...
 *        <code>EchoEventProcessor</code>
 */
NumericTextField.prototype.processKeyUp = function(echoEvent) {
...
NumericTextField.prototype.processChange = function(echoEvent) {
...
NumericTextField.prototype.validateText = function () {
...
NumericTextField.prototype.validateRange = function () {
...
NumericTextField.prototype.updateClientMessage = function() {
    var input = this.getInput();
...
NumericTextField.MessageProcessor = function() { };
...
NumericTextField.MessageProcessor.process = function(messagePartElement) {
    ...
    for (var i = 0; i<messagePartElement.childNodes.length; ++i) {
        ...
        if (messagePartElement.childNodes[i].nodeType == 1) {  // Node.ELEMENT_NODE = 1
            ...
            case "init":
                NumericTextField.MessageProcessor.processInit(messagePartElement.childNodes[i]);
                break;
...
NumericTextField.MessageProcessor.processInit = function(initMessageElement) {

    for (var item = initMessageElement.firstChild; item; item = item.nextSibling) {
    
        var elementId = item.getAttribute("eid");        
        var textComponent = new NumericTextField(elementId);
