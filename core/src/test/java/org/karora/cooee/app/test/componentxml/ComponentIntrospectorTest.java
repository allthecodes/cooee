...
/**
 * Unit tests for <code>org.karora.cooee.app.componentxml.ComponentIntrospector</code>.
 */
public class ComponentIntrospectorTest extends TestCase {
    
    public void testIntrospection() 
    throws Exception {
        ComponentIntrospector ci = ComponentIntrospector.forName("org.karora.cooee.app.Label", 
    ...
    throws Exception {
        ComponentIntrospector ci = ComponentIntrospector.forName("org.karora.cooee.app.Grid", 
                ComponentIntrospectorTest.class.getClassLoader());
