...
/**
 * Unit test(s) for the <code>org.karora.cooee.app.Component</code> object. 
 */
public class ComponentTest extends TestCase {
    ...
    public void testLifecycleSingleComponent() {
        ...
        LifecycleComponent ltc1 = new LifecycleComponent();
    ...
    public void testLifecycleComponentHierarchy() {
        ...
        LifecycleComponent ltc1 = new LifecycleComponent();
        LifecycleComponent ltc2 = new LifecycleComponent();
    ...
    public void testLifecycleRemoveDuringInit() {
        ...
        LifecycleComponent special = new LifecycleComponent(){
